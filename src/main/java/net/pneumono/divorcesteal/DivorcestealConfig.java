...
public class DivorcestealConfig {
    ...
    public static final IntegerConfiguration DEFAULT_HEARTS = new IntegerConfiguration(id(), "default_hearts", ConfigEnv.SERVER, 1, 100, 20);
    public static final IntegerConfiguration REVIVE_HEARTS = new IntegerConfiguration(id(), "revive_hearts", ConfigEnv.SERVER, 1, 100, 20);
