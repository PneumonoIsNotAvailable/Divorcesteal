...
public class DivorcestealEnUsProvider extends FabricLanguageProvider {
    public DivorcestealEnUsProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
